...
export const Header = () => {
  ...
  return (
    <header
            className="fixed top-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-md shadow-lg border-b border-[var(--light-border-color)] code-section"
            id="global-header">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex items-center justify-between h-20">
                    ...
                    <div className="flex-shrink-0">
                        <Link href="/" className="block">
                            <svg className="h-20 w-auto transition-transform duration-300 hover:scale-125 scale-150 looka-1j8o68f"
                                ...
                                <g id="SvgjsG1015" featurekey="symbolFeature-0" transform="matrix(1.25,0,0,1.25,116,94)"
                                    fill="#163a5f">
                                    <path xmlns="http://www.w3.org/2000/svg" fill="#163a5f" fillRule="evenodd"
                    ...
                    <nav className="hidden lg:flex items-center space-x-8">
                        <a href="#nuestros-servicios"
                            className="text-[var(--dark-text-color)] hover:text-[var(--primary-color)] font-medium transition-colors duration-300 relative group">
                            Nuestros Servicios
                            <span
                                className="absolute bottom-0 left-0 w-0 h-0.5 bg-[var(--primary-color)] transition-all duration-300 group-hover:w-full"></span>
                        </a>
                        ...
                        <a href="#contacto"
                            className="bg-[var(--primary-color)] text-[var(--primary-button-text-color)] px-6 py-3 rounded-lg font-semibold hover:bg-[var(--primary-button-hover-bg-color)] transition-all duration-300 hover:scale-105 shadow-lg hover:shadow-xl">
                            Solicitar Limpieza
                        </a>
                    </nav>
                    ...
                    <div className="lg:hidden">
                        <button data-landingsite-mobile-menu-toggle=""
                            className="inline-flex items-center justify-center p-2 rounded-md text-[var(--dark-text-color)] hover:text-[var(--primary-color)] hover:bg-[var(--light-background-color)] focus:outline-none focus:ring-2 focus:ring-inset focus:ring-[var(--primary-color)] transition-colors duration-300"
                ...
                <div className={`lg:hidden ${isMenuOpen ? '' : 'hidden'}`} data-landingsite-mobile-menu="">
                    <div
                        className="px-2 pt-2 pb-6 space-y-1 bg-white/95 backdrop-blur-md border-t border-[var(--light-border-color)]">
                        <a href="#nuestros-servicios"
                            className="block px-3 py-2 rounded-md text-base font-medium text-[var(--dark-text-color)] hover:text-[var(--primary-color)] hover:bg-[var(--light-background-color)] transition-colors duration-300"
                        ...
                        <a href="#contacto"
                            className="block px-3 py-2 rounded-md text-base font-medium bg-[var(--primary-color)] text-[var(--primary-button-text-color)] hover:bg-[var(--primary-button-hover-bg-color)] transition-colors duration-300 text-center"
                            onClick={() => setIsMenuOpen(false)}>
                            Solicitar Limpieza
                        </a>
                    </div>
